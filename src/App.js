...
{
  allSermons(filter: {
    id_in: ["cjhoq9p0g3g7w01103xr223pe", "cjhoq9ow735eu0186s5s6e2v3"]
  }) {
    name
    passage
    series {
...
class Sermon extends Component {
  render() {
    return (
      <div class="sermon">
        <div class="sermon--name">
          {this.props.sermon.name}
        </div>
        <div>
  ...
  render() {
    return (
      <Query query={this.props.query}>
        ...
        return (
          <div>
          { allSermons.map(sermon => <Sermon sermon={sermon} />) }
          </div>
        )
      }}
      </Query>
  ...
  render() {
    return (
      ...
      <Query query={this.props.query}>
        ...
        return (
          <div>
          { allSermonSeries.map(sermonSeries => <SermonSeries sermonSeries={sermonSeries} />) }
          </div>
        )
      }}
      </Query>
